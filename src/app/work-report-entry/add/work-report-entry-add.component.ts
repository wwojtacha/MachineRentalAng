  ...
  ngOnInit(): void {
    ...
    if (this.isOnEdit) {
      ...
      this.workReportEntryForm = new FormGroup({
        ...
        editedEstimatePosition: new FormControl({value: workReportEntry.estimatePosition.name + ';' + workReportEntry.estimatePosition.costCode.fullCode, disabled: true}),
      ...
      this.workReportEntryForm = new FormGroup({
        ...
        workQuantity: new FormControl('', [Validators.required, Validators.min(0)]),
